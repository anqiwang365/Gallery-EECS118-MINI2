...
<form action="UpdateAServlet" method="post">
	  <div class="panel-body" align="center">
	 	<div class="col-md-8 col-md-offset-1 ">
		 	...
		 	ID:&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text" name="aId" value="${artist.aId}" readonly="readonly"><br><br>
		 	NAME:&nbsp&nbsp&nbsp&nbsp<input type="text" name="name" value="${artist.name}"> <br><br>
		 	BIRTH_YEAR: &nbsp&nbsp&nbsp<input type="text" name="year" value="${artist.birth}"><br><br>
		 	COUNTRY: &nbsp&nbsp&nbsp&nbsp<input type="text" name="country" value="${artist.country}"><br><br>
		 	DESCRIPTION:&nbsp&nbsp&nbsp&nbsp <input type="text" name="description" value="${artist.aDes}"><br><br>
		 	</font>
		 	</p>
		 	<button type="submit" class="btn btn-success" >Modify</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	 	</div>
