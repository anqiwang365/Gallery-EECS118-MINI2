...
<div class="panel-heading" align="center">
        <font size="6" style="font-weight: 500;">ARTIST INFORMATION</font>
</div>
<form   method="post" action="/EECS118-MINIP2/AddAServlet">
	  <div class="panel-body" align="center">
	 	
		 	<p>
		 	<font size="4" style="font-weight: 400;">
		 	NAME:&nbsp&nbsp&nbsp<input type="text" name="name" ><br><br>
		 	BIRTH_YEAR:&nbsp&nbsp&nbsp<input type="text" name="year" ><br><br>
		 	COUNTRY: &nbsp&nbsp&nbsp<input type="text" name="country" ><br><br>
		 	DESCRIPTION:&nbsp&nbsp&nbsp <input type="text" name="description" ><br><br>
		 	</font>
		 	</p>
